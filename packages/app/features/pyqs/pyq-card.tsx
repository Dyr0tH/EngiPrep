...
export interface PYQ {
  ...
  year: string
  semester: string
  pdfUrl: string // Single URL instead of array
}
...
export function PYQCard({ pyq, onDownload }: PYQCardProps) {
  return (
    <Card
      elevate
      size="$4"
        ...
        <XStack justifyContent="space-between" alignItems="flex-start">
          <YStack flex={1} gap="$1">
            ...
            <XStack alignItems="center" gap="$2">
              ...
              <Text fontSize="$3" color="#6b7280">{pyq.subject}</Text>
            </XStack>
          </YStack>
        </XStack>
        ...
        <YStack gap="$2">
          <XStack justifyContent="space-between" alignItems="center">
            <XStack alignItems="center" gap="$2" flex={1}>
              ...
              <Text fontSize="$2" color="#9ca3af">{pyq.branch}</Text>
            </XStack>
            <XStack alignItems="center" gap="$2" flex={1}>
              <Calendar size={14} color="#9ca3af" />
              <Text fontSize="$2" color="#6b7280" fontWeight="500">Year:</Text>
              <Text fontSize="$2" color="#9ca3af">{pyq.year}</Text>
            </XStack>
          </XStack>
          ...
          <XStack justifyContent="space-between" alignItems="center">
            <XStack alignItems="center" gap="$2" flex={1}>
              ...
              <Text fontSize="$2" color="#9ca3af">{pyq.semester}</Text>
            </XStack>
          </XStack>
        </YStack>
